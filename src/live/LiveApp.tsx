...
function PrivateController() {
  ...
  if (!live.sessionId || !live.canControl) return <div className="private-page"><span className="live-eyebrow">SYNAPSE // CONTROLE PRIVADO</span><h1>Este controle precisa ser pareado.</h1><p>Abra “Conectar celular” no computador da apresentação e leia o QR code temporário. O endereço público da aula não dá acesso ao controle nem às notas.</p></div>;
